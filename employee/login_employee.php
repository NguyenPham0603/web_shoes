<?php
    include('action/login_action_emp.php');
        ...
        <div class = "wrapper_login">
            <form action="" autocomplete = "off" method = "POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="inputEmail3" name = "username_emp">
                </div>
                <div class="mb-3">
                    <label for="inputPassword3" class="form-label">Password: </label>
                    <input type="password" name = "password_emp" class="form-control" id="inputPassword3">
                </div>
                <button type="submit" class="btn btn-primary" name = "signIn_emp" style = "margin: 5px 153px;">Sign In</button>
            </form>
        </div>
    </body>
</html>
